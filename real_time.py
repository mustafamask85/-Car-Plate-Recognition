...
video_writer = cv2.VideoWriter("result.mp4",fourcc,fps,(width,height)) # this to save the output video 
...
while True:
    ...
    results = model.track(frame,persist=True,conf=0.6,iou=0.6) # passing the frame to our model to detect
